...
class proveedor extends CI_Controller
{
    ...
    public function cuenta()
    {
        ...
        $crud->setTable('proveedor');
        $crud->setSubject('Proveedor', 'Administrador de pruebas');
        $crud->columns(['Foto', 'nombre', 'rfc', 'domicilio', 'noExterior', 'noInterior', 'colonia', 'localidad', 'cp', 'ciudad', 'estado', 'pais', 'telefono1', 'telefono2', 'correo']);
